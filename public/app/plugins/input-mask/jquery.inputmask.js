                        ...
                        results = $.map(results, function (rslt, ndx) {
                            if ($.inArray(rslt["activeMasksetIndex"], maskForwards) != -1) {
                                if (rslt["result"]["pos"] == lowestPos) {
                                    ...
                                    //console.log("ndx " + rslt["activeMasksetIndex"] + " validateProduct " + masksets[rslt["activeMasksetIndex"]]["buffer"].join('') + " lv " + masksets[rslt["activeMasksetIndex"]]['lastValidPosition']);
                                    return rslt;
                                }
                            }
                        });
                    ...
                    if (typeof (value) == "object") {
                        ...
                        if (getActiveMaskSet()['lastValidPosition'] >= actualLVP || activeMasksetIndex == currentActiveMasksetIndex) {
                            if (maskPos >= 0 && maskPos < getMaskLength()) {
                                ...
                                //console.log("pos " + pos + " ndx " + activeMasksetIndex + " validateProduct " + getActiveBuffer().join('') + " lv " + getActiveMaskSet()['lastValidPosition']);
